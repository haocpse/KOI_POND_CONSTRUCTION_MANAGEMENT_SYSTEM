...
public class QuotationController {
    ...
    @GetMapping("/owned-tasks/consult")
    public ApiResponse<List<OverviewOwnedTasksResponse<QuotationStatus>>> listOwnedTasks(@RequestParam String accountId) {
        return ApiResponse.<List<OverviewOwnedTasksResponse<QuotationStatus>>>builder()
                .data(quotationService.listOwnedTasks(accountId))
                .build();
    }
//
