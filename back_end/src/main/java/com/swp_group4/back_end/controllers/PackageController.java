...
public class PackageController {
    ...
    @GetMapping("/services")
    public ApiResponse<List<PackageTypesResponse>> getAllPackagesType() {
        return ApiResponse.<List<PackageTypesResponse>>builder()
                .data(packageService.getAllPackagesType())
                .build();
    }
}
