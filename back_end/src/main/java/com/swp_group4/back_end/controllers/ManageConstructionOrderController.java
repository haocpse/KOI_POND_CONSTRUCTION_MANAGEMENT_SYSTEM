...
public class ManageConstructionOrderController {
    ...
    @GetMapping("/construct-orders")
    public ApiResponse<List<ConstructOrderDetailForManagerResponse>> listAllConstructOrders(@RequestParam String status){
        return ApiResponse.<List<ConstructOrderDetailForManagerResponse>>builder()
                .data(manageConstructionOrderService.listAllConstructOrders(status))
                .build();
    }
//
